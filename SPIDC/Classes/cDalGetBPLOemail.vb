...
#Region "Routine Command"
    Public Sub _pSubSelectGetEmailBplo()
        Try
            '----------------------------------
            ...
            _nWhere = "where UserType= 'BPLO' and isActivated=1 "
...
#Region "Routines"
    ...
    Public Sub _pSubGetEmailBplo()
        Try
            '----------------------------------

            _pSubSelectGetEmailBplo()
