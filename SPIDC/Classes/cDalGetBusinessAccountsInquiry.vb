...
Public Class cDalGetBusinessAccountsInquiry
...
#Region "Routine Command"
    ...
    Public Sub _pSubSelect()
        Try
            ...
            '----------------------------------                  
            _nQuery = _
                "SELECT acctno,COMMNAME,FORMAT (APP_DATE, 'MMMM dd, yyyy') as APP_DATE,REMARKS from BUSMAST where EMAILADDR='" & _mEmail & "' and REMARKS is not null"
            '---------------------------------- 
