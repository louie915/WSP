<%@ Page EnableEventValidation="false" Language="vb" AutoEventWireup="false" MasterPageFile="~/WebPortal/ASSESSORMaster.Master" CodeBehind="ASSESSORAppointmentList.aspx.vb" Inherits="SPIDC.ASSESSORAppointmentList" %>
           ...
           (function ($) {
               ...
               $(document).ready(function () {
                   ...
                   $.ajax({
                       ...
                       data: "{}",
                       url: "ASSESSORAppointmentList.aspx/GetEvents",
                       dataType: "json",
                              ...
                              <div class="row  form-group col-md-12 card shadow-lg ">
                                    ...
                                    <asp:GridView ID="GridViewDetails" runat="server" CssClass="GridViewStyle mgrid" AllowSorting="true" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="File Name" ItemStyle-Width="90%" Visible="false">
                                                <ItemTemplate>
