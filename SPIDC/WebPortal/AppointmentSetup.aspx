 <%@  Page  Title="" EnableEventValidation="false" Language="vb" AutoEventWireup="false" MasterPageFile="~/WebPortal/UserManagementMaster.Master" CodeBehind="AppointmentSetup.aspx.vb" Inherits="SPIDC.AppointmentSetup" %>
...
<asp:Content ID="Content2"  ContentPlaceHolderID="ContentPlaceHolder1" runat="server" ClientIDMode="Static">
 ...
 <style>
           ...
           (function ($) {
               ...
               $(document).ready(function () {
                   ...
                   $.ajax({
                       ...
                       data: "{}",
                       url: "AppointmentSetup.aspx/GetEvents",
                       dataType: "json",
            ...
            <div class="modal-header  bg-primary">
              ...
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
               ...
               <div class="col-lg-12">     
                   ...
                   <br />       
                <h6>Select Date : <i style="color:blue"> Click [Get] after selecting Date</i></h6>    
                      <div class="form-row col-12">
                            <input id="_date" runat="server" name ="_date" type="text" class="form-control  col-8" min='2020-01-01' max='2020-13-13' />
                <input type="button" value="Get" runat="server" id="btnGetSlot" class="form-control btn btn-primary col-4" />
    ...
    <form id="frmNone"></form>
     <form id="frmAdd" method="post" onsubmit="doSubmit();">
       ...
       <a href="#" class="form-control btn btn-success" data-toggle="modal" data-target="#ModalEdit" data-ticket-type="standard-access">Edit Appointment Slot</a>        
                   <br />   <br />
                   <h6>Select Department:</h6>
                                  <select name="cmbDepartment" required id="cmbDepartment" runat="server" onchange="do_Department(this.value.trim());__doPostBack(this.selectedIndex ,this.value.trim());"  class="form-control">
                ...
                <label for="WeekEnds"> Include Weekends</label> <br />
                From : <input id="dateFrom" name ="dateFrom" type="text" class="form-control" min='2020-01-01' max='2020-13-13' />
                To : <input id="dateTo" name ="dateTo" type="text" class="form-control" min='2020-01-01' max='2020-13-13' />               
           ...
           <br /> <%-- <div style="padding:10px;background-color:#F1F1F1; width:100%;">
