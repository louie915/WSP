...
Public Class BPLOAppointmentList
    ...
    Public Shared Function GetEvents() As IList
        ...
        _nQuery = "Select top 100 AppDate, Slot, COUNT(*) Ctr from Appointment WHERE isnull(RequestStatus,'0') <> '0' and OFFICE='" & cSessionUser._pOffice & "' group by appdate, slot having COUNT(*) > 0 order by appdate desc"
        ...
        Using _nSqlDr As SqlDataReader = _nSqlCommand.ExecuteReader
            ...
            If _nSqlDr.HasRows Then
                Do While _nSqlDr.Read()
                   ...
                   .Url = "BPLOAppointmentList.aspx?EventID=" & Trim(EvId) & "&EventDate=" & Format(_nSqlDr.Item("AppDate"), "yyyy-MM-dd") & "&EventTime=" & _nSqlDr.Item("Slot"),
                    .Color = colorselected
               })
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                Else
                    ...
                    sb.Append("$('#AppointmentSummaryBPLO').modal('show');")
                    sb.Append("</script>")
            ...
            Else
                ...
                If Status <> "" Then
                    ...
                    If Sent = True Then
                        ...
                        _nClass2._pSubInsertHistory(AppID, hdnEmail.Value, "Appointment", hdnAppType.Value, "Business Permits and Licensing Office", _
                                Particulars, _
                                UCase(Status))
