<%@ Page EnableEventValidation="false" Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/WebPortal/BPLOMaster.Master" CodeBehind="BPLOBusinessRenewal.aspx.vb" Inherits="SPIDC.BPLOBusinessRenewal" %>
        ...
        <div class="col-sm-12 mb-2">
            <div class="card shadow">
                <div class="card-header">
                    <label class=" font-weight-bold text-primary text-uppercase mb-1">Business Renewal Applications</label>
                </div>
                <div class="card-body">
