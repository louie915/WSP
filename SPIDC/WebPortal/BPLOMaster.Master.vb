Public Class BPLOMaster
    ...
    Private Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                If cSessionUser._pOffice = "BPLO" And cSessionUser._pUsertype = "LGU" Then
    ...
    Sub _GetCTR()
        ...
        _nClass._getNotificationCtr_BPLO()
        ctrAL.InnerText = _nClass._ctrAL  ' Appointment List
        ctrAR.InnerText = _nClass._ctrAR  ' Appointment Requests
        ctrBPI.InnerText = _nClass._ctrBPI ' BP Issuance
        ctrEBP.InnerText = _nClass._ctrEBP ' Enrollment BP
        ctrNBP.InnerText = _nClass._ctrNBP ' New BP
        ctrRBP.InnerText = _nClass._ctrRBP ' Renewal BP

        If ctrAL.InnerText = 0 Then ctrAL.Style.Add("display", "none")
        If ctrAR.InnerText = 0 Then ctrAR.Style.Add("display", "none")
        If ctrBPI.InnerText = 0 Then ctrBPI.Style.Add("display", "none")
        If ctrEBP.InnerText = 0 Then ctrEBP.Style.Add("display", "none")
        If ctrNBP.InnerText = 0 Then ctrNBP.Style.Add("display", "none")
        If ctrRBP.InnerText = 0 Then ctrRBP.Style.Add("display", "none")
