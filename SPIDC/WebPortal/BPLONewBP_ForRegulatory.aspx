<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/WebPortal/BPLOMaster.Master" CodeBehind="BPLONewBP_ForRegulatory.aspx.vb" Inherits="SPIDC.BPLONewBP_ForRegulatory" %>
...
.warning { background-color: #ffffcc;  border-left: 6px solid #ffeb3b;text-align:left}
    ...
    <div>
     ...
     <!-- Modal Temporary Approval -->
      <div id="ModalTempApprove" class="modal fade" style="z-index:1100 !important" >
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header  bg-primary">
              <h4 class="modal-title text-white">Temporary Approval</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
      ...
      <div>
                 <label class="input-txt input-txt-active2">
                    ...
                    <textarea id="txtTempApproveRemarks" runat="server" class="form-control CH-Size-New">

                    </textarea> 
             </div>               
        </div>
                      <br />
                       <input type="button" class="btn btn-primary btn-sm col col-md-5"  value="Save" runat="server" id="btnTempApprove"/>
                  </center>    
          </div>              
...
<a class="nav-link font-weight-bold text-primary" style="color:white" data-toggle="collapse" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="CODE">
                     ...
                     <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                             <center>
                            <a href="#" onclick="do_Select('<%# Eval("REQCODE")%>','<%# Eval("REQDESC")%>','<%# Eval("Application_ID")%>')"> View/Process </a>
                                              </center>
                                  </ItemTemplate>
                        <ItemStyle CssClass="cssGridViewItemStyleLeft"  />
                    </asp:TemplateField>               
    ...
    <br />
         <a href="#" id="lnkTempApprove" runat="server" class="btn btn-primary btn-sm col col-md-5"   data-toggle="modal" data-target="#ModalTempApprove" data-ticket-type="standard-access" >Temporarily Approve All</a>
      <br /> <br />

           </div>
        <br />
        <div id="divComplete" runat="server" class="alert alert-success">
