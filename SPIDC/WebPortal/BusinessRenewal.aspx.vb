...
Public Class BusinessRenewal
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack Then
            ...
            '   newsb.Append("</script>")
            '   ClientScript.RegisterStartupScript(Me.[GetType](), "NewJSScript", newsb.ToString())
        ...
        Else
            ...
            If action = "declineapplication" And val = "submit" Then
                _mSubDeclineApplication()
                Exit Sub
            End If
    ...
    Sub Post_OK()
        ...
        End Try
    End Sub
    Private Sub _mSubDeclineApplication()
        ...
        Try
            ...
            ''Dim _nClass1 As New cDalSendEmail
            ''With _nClass1
            ''    ._pEmailTo = _nTPEmail
            ''    ._pSubject = "Account Ready for Payment"
            ...
            Subject = "Decline submission of business renewal" 'jake

            Body = "To our Valued Taxpayer, <br>" & _
                    "We found the following findings in our review and evaluation of your submitted Business Documents for Business Account: <b> " & _
                      cSessionLoader._pAccountNo & " </b> registered under the commercial name <b>" & _oLblBusName.Text & "</b>. <br>" & _
                    " " & _oTextRemarks.Value & "  <br><br> " & _
                    "Please comply with the necessary documents to proceed with the Transaction. Thank You! <br>" & _
                    "This is an electronic message, Please do not reply"
            cDalNewSendEmail.SendEmail(_nTPEmail, Subject, Body, Sent)
            If Sent = True Then
