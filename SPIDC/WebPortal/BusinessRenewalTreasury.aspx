<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/WebPortal/LGUOSMainPage.Master" CodeBehind="BusinessRenewalTreasury.aspx.vb" Inherits="SPIDC.BusinessRenewalTreasury" %>
    ...
    <div  class="card mt-2">
        ...
        <div   class="col-lg-12">
            ...
            <div class="form-row form " >
                ...
                <div class="form-group mx-4 my-2">            
                    <button type="button" data-toggle="modal" data-target="#myModal" class="text-white btn-primary d-flex align-items-center justify-content-center align-content-end">View Owner's Profile</button>        
                </div>   
             ...
             <asp:GridView ID="_GVBusinessLine" runat="server" CssClass="mGrid col-lg-10 get-gross" AllowSorting="true"  
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Tax Payer Gross" ItemStyle-HorizontalAlign="right" ItemStyle-Width="15%">
                     ...
                     <asp:TemplateField HeaderText="Treasury Gross" ItemStyle-HorizontalAlign="right" ItemStyle-Width="15%">
                        <ItemTemplate>
...
<a class="nav-link font-weight-bold text-primary" style="color:white" data-toggle="collapse" 
    ...
    >  Billing Information        </a>
            ...
            <div runat="server" id="div_AssessNotice">
                <center>
                <div class="w3-panel  w3-pale-yellow"> 
                     <h3>Account not yet Assesed</h3>
  <p>
      Please go to BPLTAS and proceed with Process of Renewal. Refresh this page after Assesssment<br>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
        ...
        <div class="modal fade" id="modadeclineapplciation">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-primary">                       
                    <h4 class="modal-title text-white" id="modadeclineapplciationlabel">Decline Application - Notify Taxpayer</h4>
                        <button type="button" class="close text-white" data-dismiss="modal" aria-hidden="true">&times;</button>
                    </div>
                    <div class="modal-body">                       
                        <label class="text-xs font-weight-light text-primary text-uppercase mb-1">Subject </label>
                        <input type="text" id="txt_Subject" runat="server" class="form-control"/>
                        <label class="text-xs font-weight-light text-primary text-uppercase mb-1">Header </label>
                        <input type="text" id="txt_Header" runat="server" class="form-control"/>
                        <label class="text-xs font-weight-light text-primary text-uppercase mb-1">Body </label>
                        <textarea id="txt_Body" runat="server" rows="10" class="form-control"></textarea>
                  
                       
                    </div>
                    <div class="modal-footer">            
                        <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal"  >Cancel</button>            
                        <button type="button" class="btn btn-success btn-sm" data-dismiss="modal"  id="_obtnSubmit" runat="server" >Submit</button>      
                    </div>
                </div>
            </div>
        </div>
