...
Public Class LGUAppointmentList
    ...
    Public Shared Function GetEvents() As IList
        ...
        _nQuery = "Select top 100 AppDate, Slot, COUNT(*) Ctr from Appointment WHERE OFFICE='" & cSessionUser._pOffice & "' group by appdate, slot having COUNT(*) > 0 order by appdate desc"
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                If cSessionLoader._pKeyToken <> _mKeyToken Then
                    ...
                    Exit Sub
                ElseIf cSessionUser._pOffice <> "TREASURY" Then
            ...
            Else
                ...
                If Status <> "" Then
                    ...
                    If Sent = True Then
                        ...
                        _nClass2._pSubInsertHistory(AppID, hdnEmail.Value, "Appointment", hdnAppType.Value, "Treasury Office", _
                                Particulars, _
                                UCase(Status))
