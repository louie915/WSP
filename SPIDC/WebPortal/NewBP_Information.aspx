<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/WebPortal/OSMainPage.Master" CodeBehind="NewBP_Information.aspx.vb" Inherits="SPIDC.NewBP_Information" %>
...
.warning { background-color: #ffffcc;  border-left: 6px solid #ffeb3b;text-align:left}
    ...
    <div>
        ...
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                    <div id="snackbar" style="position:absolute;z-index:1200 !important">
                    <asp:Label runat="server" id="_oLabelSnackbar"/>           
                </div>
                <div id="snackbargreen" style="position:absolute;z-index:1200 !important">
      ...
      <div id="ModalView" class="modal fade" style="z-index:1100 !important" >
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
             ...
             <div>
                        Remarks:
                        <textarea runat="server" id="txt_ImageRemarks" aria-multiline="true" readonly style="height:50px;width:100%;" ></textarea>
                    </div>              
     ...
     <!-- Modal View Attachment Form -->
      <div id="ModalView2" class="modal fade" style="z-index:1100 !important" >
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header  bg-primary">
     ...
     <!-- Modal Regulatory Form -->
      <div id="ModalRegulatory" class="modal fade" >
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header  bg-primary">
              <h4 class="modal-title text-white" runat="server" id="ModalRegulatoryTitle"></h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Date Submitted">
                     ...
                     <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                             <center>
                            <a href="#" onclick="do_embed('<%# Eval("Application_ID")%>','<%# Eval("ReqCode")%>','<%# Eval("ReqDesc")%>','<%# Eval("File_Type")%>','<%# Eval("File_Data64")%>')" data-toggle="modal" data-target="#ModalView" data-ticket-type="standard-access"> View </a>
    ...
    <asp:GridView ID="GridView3" runat="server" CssClass="mGrid Table-MobileView" AllowSorting="true"
                ...
                <Columns>                    
                    ...
                    <asp:TemplateField HeaderText="Fee Amount" ItemStyle-HorizontalAlign="Right">
                        <ItemTemplate>                   
                            <input type="text" runat="server" id="txtFeeAmt" placeholder='<%# Eval("FeeAmt")%>' value='<%# Eval("FeeAmt")%>' style="width:100%;text-align:right"  readonly/>
                        </ItemTemplate>
                        <ItemStyle CssClass="cssGridViewItemStyleLeft"  />
                    </asp:TemplateField>           
                </Columns>
      ...
      <div>
          ...
          <input type="text" id="txt_Status" runat="server" class="form-control CH-Size-New" readonly/>        
             </div>               
        </div>
 ...
 <div class="form-group col col-md-6" style="display:inline-block">
      <div>
                 <label class="input-txt input-txt-active2">
                    ...
                    <input id="txt_Remarks"  runat="server" readonly type="text" class="form-control CH-Size-New"  />
             </div>               
        </div>
     ...
     <div class="container">
           <center>
               <h2>New Business Application - Information</h2>
               <div class="col-md-10">
...
<a class="nav-link font-weight-bold text-primary" style="color:white" data-toggle="collapse" 
    href="#div_Info" role="button" aria-haspopup="true" aria-expanded="false">  Business Information         </a>
      ...
      <div id="div_Info" class="MainDiv collapse show" style="border:2px double lightgray">
...
<table id="Information">
        ...
        <div class="btn-primary" style="text-align:left;background-color:lightgray">  
<a class="nav-link font-weight-bold text-primary" style="color:white" data-toggle="collapse" 
    href="#div_Regulatory" role="button" aria-haspopup="true" aria-expanded="false">  Regulatory Requirements         </a>
</div>  
      ...
      <div id="div_Regulatory" class="MainDiv collapse show" style="border:2px double lightgray">
        ...
        <ContentTemplate>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="CODE">
                      ...
                      <asp:TemplateField HeaderText="Description">
                        ...
                        <asp:TemplateField HeaderText="Assessed By">
                        <ItemTemplate>
                            <asp:Label ID="lbl_AssessedBy" runat="server" Text='<%# Eval("Assessed_By")%>' />
                        </ItemTemplate>
                        <ItemStyle CssClass="cssGridViewItemStyleLeft"  />
                    </asp:TemplateField>
                        <asp:TemplateField HeaderText="Status">
                     ...
                     <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                             <center>
                            <a href="#" onclick="do_Select('<%# Eval("REQCODE")%>','<%# Eval("REQDESC")%>','<%# Eval("Application_ID")%>')"> View</a>
                                              </center>
                                  </ItemTemplate>
                        <ItemStyle CssClass="cssGridViewItemStyleLeft"  />
                    </asp:TemplateField>               
          ...
          <input type="button" runat="server"  id="btnSelect" style="display:none"   />
    ...
    <input type="hidden" id="hdnReqCode" runat="server" />
    <input type="hidden" id="hdnDesc" runat="server" />
    ...
    <script>
        function do_embed(AppID, ReqCode, File_Name, File_Type, File_Data) {
            ...
            document.getElementById('<%= hdnReqCode.ClientID%>').value = ReqCode;
        ...
        function do_Select(Code, Desc, AppID) {
            document.getElementById('<%= hdnCode.ClientID%>').value = Code;
            document.getElementById('<%= hdnDesc.ClientID%>').value = Desc;
