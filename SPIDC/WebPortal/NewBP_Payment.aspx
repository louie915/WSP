<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/WebPortal/OSMainPage.Master" CodeBehind="NewBP_Payment.aspx.vb" Inherits="SPIDC.NewBP_Payment" %>
...
<a class="nav-link font-weight-bold text-primary" style="color:white" data-toggle="collapse" 
    ...
    >  Billing Information        </a>
     ...
     <div class="collapse show" id="_oPNGrid_Regulatory">        
      ...
      <h3>Information!</h3>
  <p>For Over-The-Counter Payments, please make sure you have Printed Copy of your <b>Tax Order of Payment (TOP)</b>.</p>
</div>      
           ...
           <div class="form-row">
               <div class="form-group col-md-4">
                   <div>
                       <input type="button" runat="server" id="btnAppForm" value="Download App Form" class="btn btn-primary col-lg-12"/>
                   </div>
               </div>
               <div class="form-group col-md-4">
                   <div>
                      <input type="button" value="Download T.O.P" runat="server" id="btn_TOP" class="btn btn-primary col-lg-12"/> 
                   </div>
               </div>
                <div class="form-group col-md-4">
                   <div>
                      <input type="button" runat="server" id="btnPayment" value="Proceed to Payment" class="btn btn-primary col-lg-12"/>
                   </div>
               </div>
           </div>
