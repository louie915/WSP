...
Public Class RegulatoryAppointmentList
    ...
    Public Shared Function GetEvents() As IList
        ...
        _nQuery = "Select top 100 AppDate, Slot, COUNT(*) Ctr from Appointment WHERE isnull(RequestStatus,'0')<>'0' OFFICE='" & cSessionUser._pOffice & "' group by appdate, slot having COUNT(*) > 0 order by appdate desc"
        ...
        Using _nSqlDr As SqlDataReader = _nSqlCommand.ExecuteReader
            ...
            If _nSqlDr.HasRows Then
                Do While _nSqlDr.Read()
                   ...
                   .Url = "RegulatoryAppointmentList.aspx?EventID=" & Trim(EvId) & "&EventDate=" & Format(_nSqlDr.Item("AppDate"), "yyyy-MM-dd") & "&EventTime=" & _nSqlDr.Item("Slot"),
                    .Color = colorselected
               })
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                If cSessionLoader._pKeyToken <> _mKeyToken Then
                    ...
                    Exit Sub
                ElseIf cSessionUser._pUsertype <> "REGULATORY" Then
                ...
                Else
                    ...
                    sb.Append("$('#AppointmentSummaryRegulatory').modal('show');")
                    sb.Append("</script>")
            ...
            Else
                ...
                If Status <> "" Then
                    ...
                    If Sent = True Then
                        ...
                        _nClass2._pSubInsertHistory(AppID, hdnEmail.Value, "Appointment", hdnAppType.Value, "Appointment Scheduler", _
                                Particulars, _
                                UCase(Status))

                    Else
                        snackbar("red", "Email confirmation Failed to send, Please try again.")
                    End If
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        Try
            ...
            Response.Write("<script>window.open ('Report/ReportViewer.aspx?" & _
                           ...
                           "&To=" & AppTo.Value & _
                            "&SortBy=" & cmbSorting.Value & "','_blank');</script>")
