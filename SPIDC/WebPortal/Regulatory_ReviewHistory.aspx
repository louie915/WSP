<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/WebPortal/RegulatoryMaster.Master" CodeBehind="Regulatory_ReviewHistory.aspx.vb" Inherits="SPIDC.Regulatory_ReviewHistory" %>
  ...
  <tr>
   ...
   <td runat="server" id="td_FileName6" style="display:none;"> File Name </td>  
    ...
    <td runat="server" id="td_FileStatus6">  </td>    
                ...
                <br />
          <div class="btn-primary" style="text-align:left">     
                      <strong > &nbsp LINE OF BUSINESS - BPLO Input</strong>
    </div> 
...
<table id="Information">
     ...
     <div class="form-group col col-md-11" style="display:inline-block">
      <div>
                 <label class="input-txt input-txt-active2">
                       <span><span class="m-2">Clearance Number </span></span>
                 </label>
                    <input id="txt_Clearance_No" readonly  runat="server"  type="text" class="form-control CH-Size-New" style="text-align:center"  />
             </div>               
        </div>
 ...
 <div class="form-group col col-md-6" style="display:inline-block">
    ...
    <div style="text-align:left">
        <b style="color:cornflowerblue" >&nbsp  Fees Entered </b>        
    </div>    
   ...
   <asp:GridView ID="GridView2" runat="server" CssClass="mGrid Table-MobileView" AllowSorting="true"
                ...
                <Columns>                    
                    ...
                    <asp:TemplateField HeaderText="Fee Amount" ItemStyle-HorizontalAlign="Right">
                        <ItemTemplate>  
                              <asp:Label  ID="txtFeeAmt" runat="server" Text='<%# Eval("FeeAmt")%>' /> 
                        </ItemTemplate>
                        <ItemStyle CssClass="cssGridViewItemStyleLeft"  />
                    </asp:TemplateField>           
                </Columns>
  ...
  <br />
      ...
      <div>
          ...
          <label class="form-control CH-Size-New" id="txt_Status" runat="server"></label>
      ...
      <div>
                 <label class="input-txt input-txt-active2">
                       <span><span class="m-2">Date Assessed</span></span>
                 </label>
             <label class="form-control CH-Size-New" id="txt_Date_Assessed" runat="server"></label>
             </div>               
        </div>        
          <div class="form-group col col-md-4" style="display:inline-block">
      <div>
                 <label class="input-txt input-txt-active2">
                       <span><span class="m-2">Assessed By</span></span>
                 </label>
             <label class="form-control CH-Size-New" id="txt_Assessed_by" runat="server"></label>
             </div>               
        </div>   
      <div class="form-group col col-md-11" style="display:inline-block">
      <div>
             ...
             <label class="form-control CH-Size-New" id="txt_Remarks"  runat="server">
