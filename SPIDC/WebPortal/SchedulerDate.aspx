<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/WebPortal/SchedulerMaster.Master" CodeBehind="SchedulerDate.aspx.vb" Inherits="SPIDC.SchedulerDate" %>
                 ...
                 (function ($) {
                     ...
                     $(document).ready(function () {      
                         ...
                         $.ajax({
                             ...
                             data: "{}",
                             url: "SchedulerDate.aspx/GetEvents",
                             dataType: "json",
     ...
     <div class="row justify-content-center align-items-center card form mb-0"> 
        <div class=" row col-md-12">
              ...
              <div class="form-row col-md-12 m-0 row d-flex justify-content-center">
                ...
                <%-- <div class="col-md-10 border-dark border row"> 
                     <div class="col-lg-4 my-2">
                          <input type="file" id="up2" runat="server" style="display: none;" onchange="Set_Label(this);"/>
                          <input type="button" value="Choose File" onclick="document.getElementById('up2').click();" />
                          <label id="lblup2"  runat="server">No File Chosen</label>
                  ...
                  <div class="col-md-10 border-dark border row "> 
                     <div class="col-lg-4 my-2">
                           <input type="file" id="up3" runat="server" style="display: none;" onchange="Set_Label(this);"/>
                         <input type="button" value="Choose File" onclick="document.getElementById('up3').click();" />
                          <label id="lblup3"  runat="server">No File Chosen</label>   
                  ...
                  <div class="col-md-10 border-dark border row "> 
                     <div class="col-lg-4 my-2">
                           <input type="file" id="up4" runat="server" style="display: none;" onchange="Set_Label(this);"/>
                         <input type="button" value="Choose File" onclick="document.getElementById('up4').click();" />
                          <label id="lblup4"  runat="server">No File Chosen</label>
                  ...
                  <div class="col-md-10 border-dark border row "> 
                     <div class="col-lg-4 my-2">
                           <input type="file" id="up5" runat="server" style="display: none;" onchange="Set_Label(this);" />
                         <input type="button" value="Choose File" onclick="document.getElementById('up5').click();" />
                          <label id="lblup5"  runat="server">No File Chosen</label>
