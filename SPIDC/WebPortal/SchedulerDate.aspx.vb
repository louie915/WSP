...
Public Class SchedulerDate
            ...
            If _nSqlDr.HasRows Then
                Do While _nSqlDr.Read()
                    ...
                    If _nSqlDr.Item("AM_Slot") > 0 Then
                       ...
                       .Url = "SchdedulerDate.aspx?EventID=" & EvId & "AM&EventDate=" & Format(_nSqlDr.Item("AppDate"), "yyyy-MM-dd") & "&EventTime=AM",
                       .Color = colorseleced
                   })
                    End If
                    ...
                    If _nSqlDr.Item("PM_Slot") > 0 Then
                       ...
                       .StartDate = _nSqlDr.Item("AppDate").ToString,
                       .EndDate = _nSqlDr.Item("AppDate").ToString,
                       .Url = "SchdedulerDate.aspx?EventID=" & EvId & "PM&EventDate=" & Format(_nSqlDr.Item("AppDate"), "yyyy-MM-dd") & "&EventTime=PM",
                        .Color = colorseleced
                        })
                    End If
    ...
    Sub upload_Docs()
        ...
        Dim RefNo As String = _nclass._pEventID
        ...
        If up1.PostedFile IsNot Nothing And up1.PostedFile.ContentLength > 0 Then
            ...
            If valid = True Then
                ...
                If _FnNotify_Taxpayer(imgBarCode.ImageUrl, Hash) = True Then
                    _oLabelPurpose.InnerText = cDalAppointment._mPurpose
                    _nclass._pSubInsertAppointmentOTHERS(email, TransType, Appdate, AppTime, AppID, Owner, AcctID, Status, Remarks, DeptAbbrev, Purpose, Hash)
                    _nclass._pSubUpdateAppointmentSlot(Appdate, AppTime, DeptAbbrev)
                    _nclass._pSubUpdateAttachRefNo(email, RefNo, ModuleID, AcctID, Appdate, AppTime)
                    _nclass._pSubUpdateAppointmentCode(email, cSessionLoader._pCode)
