<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/VS2014.IMC/IMC.Master" CodeBehind="BPLTIMSCertification.aspx.vb" Inherits="IMC.Certification" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">        
     <script type="text/javascript">
         function getSelectedBusiness(sBus) {
             document.getElementById('<%=txtSelectedBusiness.ClientID%>').value = sBus.value;
            var BusName = document.getElementById('<%=cmbBusinessAccount.ClientID%>');
             document.getElementById('<%=txtSelectedBusinessName.ClientID%>').value = BusName.options[BusName.selectedIndex].text;           
        }
 ...
 <!--==========================
    ...
    <ContentTemplate>
                   ...
                   <asp:GridView ID="_oGridViewRequestStatus" CssClass="footable" runat="server" AutoGenerateColumns="false"
                    HeaderStyle-BackColor="#3AC0F2" HeaderStyle-ForeColor="White" allowpaging="true" pagesize="50"
 ...
 <center>
          <div class="col-lg-7">
            ...
            <div class="form-row">
                  ...
                  <select required runat="server" id="cmbBusinessAccount" name="cmbBusinessAccount" class="form-control" onchange="getSelectedBusiness(this)" >   
                   ...
                   <div class="form-group col-md-6">            
                  <select required runat="server" clientidmode="static" id="cmbCertifications" name="cmbCertifications" class="form-control" onchange="getSelectedCertificate(this)" >   
            ...
            <div class="modal-body">
               <form action="" method="post">
                <div class="form-group">                               
                  ...
                  <input  runat="server" class="form-control" readonly="true" id="txtSelectedBusiness" ClientIDMode="Static"/>
                </div>
                    <div class="form-group">                               
                     Business Name        <br />
                   <input  runat="server" class="form-control" readonly="true" id="txtSelectedBusinessName" ClientIDMode="Static"/>    
                </div>
