<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Cedula.aspx.vb" Inherits="SPIDC.Cedula" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Web Service Portal - CEDULA</title>
...
<body>
  ...
  <h3>Success!</h3>
  <p>You may now Proceed to the counter and Present your Control Number :</p>
   <table id="customers">
       <tr>
  ...
  <div class="w3-row">
    <a href="javascript:void(0)" onclick="openCTC(event, 'Individual');IndividualClick();">
      <div class="w3-quarter tablink w3-bottombar w3-hover-light-grey w3-padding w3-border-blue">Cedula (Individual)</div>
    </a>
    <a href="javascript:void(0)" onclick="openCTC(event, 'Corporation');CorporationClick();">
      <div class="w3-quarter tablink w3-bottombar w3-hover-light-grey w3-padding">Cedula (Corporation)</div>
    </a>
   
  </div>

  <div id="Individual" class="w3-container CTC" style="display:block;border:1px ">
    <h2>Individual</h2>
    <div class="mx-1 d-flex justify-content-center mt-3">       
          ...
          <div class="col-md-6 mt-2 d-flex justify-content-center">
                    ...
                    <div class="col-lg-12 row">
                       ...
                       <input name="btnPayNowInd" id="btnPayNowInd" type="button" runat="server" class="btn btn-primary col-md-2 col-lg-4 m-2 btn-sm"  value="Submit" >
  ...
  <div id="Corporation" class="w3-container CTC" style="display:none">
    <h2>Corporation</h2>
     <div class="mx-1 d-flex justify-content-center mt-3">
            <div class="row col-lg-12 d-flex justify-content-center">
               ...
               &nbsp  I am getting this cedula for myself. 
                    ...
                    <div class="col-md-12 d-flex justify-content-center row">
                     ...
                     <input name="btnPayNowCorp" id="btnPayNowCorp" type="button" runat="server" class="btn btn-primary col-md-2 col-lg-4 m-2 btn-sm" value="Submit"/>
        ...
        <input type="hidden" runat="server" id="_oTxtHdnCedulaInd" value="1" />
        <input type="hidden" runat="server" id="_oTxtHdnCedulaCorp"  value="0" />
...
function EnableDisableSalary() {
 ...
 function calculateAmount() {
     ...
     if (radioProfession.value == "" || radioProfession.value.toUpperCase=="UNEMPLOYED") {
                 Unemployed = 15;
                 var x = 0
                 document.getElementById('<%=_oTxtSalary.ClientID%>').disabled = true
                 document.getElementById('<%=_oTxtSalary.ClientID%>').value = "0.00"
       ...
       function formatSalary(val) {
        ...
        <script>
            function openCTC(evt, CTCType) {
                ...
                document.getElementById(CTCType).style.display = "block";
