<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/WebPortal/LGUappointmentMaster.Master" CodeBehind="AppointmentApproval.aspx.vb" Inherits="SPIDC.AppointmentApproval" EnableEventValidation="false" %>
 <%--MasterPageFile="~/WebPortal/UserManagementMaster.Master"--%>
        ...
        <div class="form-group col-lg-12" style="border-radius: 1vh; border: 1px solid lightgray">
            ...
            <div  class="form-row col-lg-12" >
                ...
                <div class="form-group col-lg-2" style=" display:none">
                    ...
                    <select runat="server" id="cmbOFFICEFilter" class="form-control" onchange="do_Something('Get_Type',this.value);">
