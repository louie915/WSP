<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/WebPortal/BPLOMaster.Master" CodeBehind="BPLOAppointmentList.aspx.vb" Inherits="SPIDC.BPLOAppointmentList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" ClientIDMode="Static">
        ...
        (function ($) {
            ...
            $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    data: "{}",
                    url: "BPLOAppointmentList.aspx/GetEvents",
                    dataType: "json",
    ...
    <div id="AppointmentSummaryBPLO" class="modal fade">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="AppDateSelected" runat="server">
                        <asp:GridView ID="GV_AppList" runat="server" CssClass="GridViewStyle mgrid col-12" AllowSorting="true" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Details" HeaderStyle-Width="20%">
                                    <ItemTemplate>
                                        <a href="#" onclick="do_view('<%# Eval("Remarks")%>','<%# Eval("ServedBy")%>','<%# Eval("Purpose")%>','<%# Eval("Name")%>','<%# Eval("AppID")%>','<%# Eval("Status")%>','<%# Eval("Email")%>','<%# Eval("AppDate")%>','<%# Eval("Slot")%>','<%# Eval("TransDate")%>','<%# Eval("AcctID")%>','<%# Eval("TransType")%>');" class="btn btn-primary col-12">View</a>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                    ...
                    <div id="AppIDSelected" style="display: none">
                        <div class="form-group">
                            <input type="button" class="btn btn-secondary col-2" value="Back" onclick="do_back();" />
                            <div class="card-footer">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <asp:TextBox runat="server" ID="_otxtAppRemarks" class="form-control CH-Size" TextMode="MultiLine" Rows="3" />

                                    </div>
                                   
                                        <div class="form-group col-lg-12">
                                             <center>
                                            <input type="button" class="btn btn-success col-6" value="Save" onclick="do_save();"/>
                                                  </center>
                                        </div>                                        
    ...
    <div class="row justify-content-center align-items-center card form mb-0">
        <div class=" row col-md-12">
            ...
            <div class="d-flex justify-content-center col-lg-12">
                <div id="fullcal">
                    <br />
                    <input type="button" class="btn btn-primary" data-toggle="modal" data-target="#AppointmentPrinting" data-ticket-type="standard-access" value="Print Appointment List" /><br />
                    <br />
