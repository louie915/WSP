<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/WebPortal/DILGMaster.Master" CodeBehind="DILGInspectionRequest.aspx.vb" Inherits="SPIDC.DILGInspectionRequest" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script>
        ...
        function datefunction() {
            ...
            document.getElementById('<%=_oTextDateInspect.ClientID%>').setAttribute('min', minDate);
            document.getElementById('<%=_oTextDateInspect.ClientID%>').value = new Date().toDateInputValue();
        }
        addLoadEvent(datefunction);
        ...
        //document.getElementById('_oTextDateInspect').value = new Date().toDateInputValue();
